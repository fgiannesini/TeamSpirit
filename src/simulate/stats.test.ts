...
describe('stats', () => {
  ...
  test('should compute a lead time on two tasks reviewed by two devs', () => {
    expect(
      computeStatEvents([
        { time: 1, userStoryName: 'US1', thread: 0, state: State.InProgress },
        { time: 1, userStoryName: 'US0', thread: 1, state: State.InProgress },
        { time: 1, userStoryName: 'US0', thread: 1, state: State.ToReview },
        { time: 2, userStoryName: 'US1', thread: 0, state: State.InProgress },
        { time: 2, userStoryName: 'US1', thread: 0, state: State.ToReview },
