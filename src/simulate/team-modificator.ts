...
export class CustomTeamModificator implements TeamModificator {
    setThreadsIn(team: Team): { team: Team; newThreadsIn: Pick<Thread, "id" | "name">[] } {
        return {newThreadsIn: [], team: team};
    }

    setThreadsOff(team: Team): { team: Team; newThreadsOff: Pick<Thread, "id" | "name">[] } {
        return {newThreadsOff: [], team: team};
    }
